 ...
 */
//creating a function that prints the value to the console.
function print(value) { //designating parameters.
  // YOUR CODE BELOW HERE //
  return console.log(value); //returns the value printed to the consoe.
